...
#elif (CONFIG_DEBUG_UART_BASE == STM32_UART5_BASE)

#define RCC_MP_APB1ENSETR (STM32_RCC_BASE + 0x0A00)
#define RCC_MP_AHB4ENSETR (STM32_RCC_BASE + 0x0A28)

	/* UART4 clock enable */
	setbits_le32(RCC_MP_APB1ENSETR, BIT(17));

#define GPIOB_BASE 0x50003000
	/* GPIOB clock enable */
	writel(BIT(1), RCC_MP_AHB4ENSETR);
	/* GPIO configuration for EVAL board
	 * => Uart5 TX = B6
	 */
	writel(0xffffefff, GPIOB_BASE + 0x00);
	writel(0x0C000000, GPIOB_BASE + 0x20);
#else 
